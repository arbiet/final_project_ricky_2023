            ...
            <div class="max-w-lg mx-auto mt-4">
                <form action="process_create_product.php" method="POST" enctype="multipart/form-data">
                    <div class="mb-4">
                        ...
                        <input type="text" id="productName" name="productName" class="border p-2 w-full" required>
                    </div>

                    <div class="mb-4">
                        <label for="productImage" class="block text-gray-800 font-bold">Product Image:</label>
                        <input type="file" id="productImage" name="productImage" accept="image/*" class="border p-2 w-full" required>
                    </div>

                    <div class="mb-4">
                        <label for="description" class="block text-gray-800 font-bold">Description:</label>
                        <textarea id="description" name="description" class="border p-2 w-full" rows="3"></textarea>
                    </div>
