...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 12 Des 2023 pada 15.51
...
--
-- Struktur dari tabel `DailyTransactions`
--
...
--
-- Dumping data untuk tabel `DailyTransactions`
--
...
(268, 21, 3, 'Out', '2023-11-29'),
(269, 20, 4, 'Out', '2023-08-30'),
...
(0, 'ricky', 'ef797c8118f02dfb649607dd5d3f8c7623048c9c063d532cc95c5ed7a898a64f', 'rickylaschka@gmail.com', 'Ricky Laschka Zidane Santoso', '2000-08-05', 'Male', 'Pare', '085236777545', 2, '2023-12-05 15:22:36', '2023-12-05 22:22:36', NULL, '653e5a409b4fb.jpeg', NULL),
...
--
-- Indeks untuk tabel `DailyTransactions`
--
...
--
-- Indeks untuk tabel `LogActivities`
--
...
--
-- AUTO_INCREMENT untuk tabel `DailyTransactions`
--
ALTER TABLE `DailyTransactions`
  MODIFY `TransactionID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=578;

--
-- AUTO_INCREMENT untuk tabel `LogActivities`
--
ALTER TABLE `LogActivities`
...
--
-- Ketidakleluasaan untuk tabel `DailyTransactions`
--
ALTER TABLE `DailyTransactions`
...
--
-- Ketidakleluasaan untuk tabel `LogActivities`
--
ALTER TABLE `LogActivities`
